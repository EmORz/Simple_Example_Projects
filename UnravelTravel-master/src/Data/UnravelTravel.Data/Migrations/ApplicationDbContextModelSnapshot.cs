...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UnravelTravel.Data.Models.Destination", b =>
                {
                    ...
                    b.Property<double>("UtcRawOffset");
            ...
            modelBuilder.Entity("UnravelTravel.Data.Models.UnravelTravelUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("UnravelTravel.Data.Models.UnravelTravelUser")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("UnravelTravel.Data.Models.Reservation", b =>
                {
                    ...
                    b.HasOne("UnravelTravel.Data.Models.UnravelTravelUser", "User")
                        .WithMany("Reservations")
                        .HasForeignKey("UserId");
                });
            ...
            modelBuilder.Entity("UnravelTravel.Data.Models.UnravelTravelUser", b =>
                {
                    b.HasOne("UnravelTravel.Data.Models.ShoppingCart", "ShoppingCart")
                        .WithOne("User")
                        .HasForeignKey("UnravelTravel.Data.Models.UnravelTravelUser", "ShoppingCartId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
